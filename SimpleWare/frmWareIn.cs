...
{
    public partial class frmWareIn : Office2007Form
    {
        public frmWareIn()
        {
            InitializeComponent();
        ...
        tb_BaseMgr tb_basemgr = new tb_BaseMgr();
        ...
        private void frmWareInOut_Load(object sender, EventArgs e)
        {
            ...
            //tb_BaseMgr.SetCombox("worknum", tbwarehourse);
            tb_BaseMgr.SetCombox("material", tbMaterial);

            tb_BaseMgr.SetCombox("InvoiceTypeIn", cmbinvoicetype);
            tb_BaseMgr.SetCombox("InvoiceTypeIn", cbintype);
        ...
        private void InitializeGrid()
        {
            ...
            column4.EditorType = typeof(InvoiceTypeInComboxControl);
        }
        ...
        private void UpdateBindings(object context)
        {
            ...
            if (context != null)
            {
                ...
                //MemoryStream buf = new MemoryStream((byte[])context["iFimage"]);
               ...
               /* if (Bm.Position >= 0)
                {
                    ...
                    //DataColumn dc = dr["Fimage"];
                    if (!(dr["Fimage"] is System.DBNull))
                    {
                        MemoryStream buf = new MemoryStream((byte[])dr["Fimage"]);
                        Image image = Image.FromStream(buf, true);
                        pictureBox1.Image = image;
                    }
                }*/
        ...
        private bool checksaved()
        {
            ...
            {
                MessageUtil.ShowError("入库类型必须输入！");
                return false;
            }
            return true;
        }
                ...
                if (ds1.Tables.Count > 0)
                {
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < ds1.Tables[0].Rows.Count; i++)
                        {
                            ...
                            cbwarehouse.Items.Add(ds1.Tables[0].Rows[i][1].ToString());
                        }
                    }
                    ...
                    tbwarehourse.DataSource = ds1.Tables[0];
                    tbwarehourse.DisplayMember = "WareName";
                    tbwarehourse.ValueMember = "WareID";
                }
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            ...
            if (ds != null)
            {
                ...
                ExcelHelper.superGridToExcel(supergrid, "入库登记");
            }
